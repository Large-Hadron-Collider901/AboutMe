...
function playGame(){
    ...
    alert("I am going to ask you five questions about myself, all you need to do is try to guess the correct answer by entering either 'yes' or 'no'. Press OK to begin!");
   ...
   alert("Thanks so much for playing my game today, " + userName + "!  I hope you had fun learning a little bit about me!")
}
